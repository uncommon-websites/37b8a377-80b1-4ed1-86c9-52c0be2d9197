...
<script lang="ts">
	...
	const teamMember: TeamMember = {
		...
		role: "Founder & CEO",
		image: "/generated/image-a-professional-headshot-of-a-confident-m.webp"
	};
</script>
	...
	<div class="section-px section-py container mx-auto">
		<div class="relative mx-auto grid max-w-2xl place-items-center gap-16">
			<ScrollText
				...
				text={`"After 15 years navigating vessels through unpredictable oceans, I realized the maritime industry was drowning in inefficiency while technology could be our lifeline. Every delayed shipment, every gallon of wasted fuel, every stressed operations manager I met convinced me we needed to turn real-time ocean intelligence into competitive advantage."`}
			/>
